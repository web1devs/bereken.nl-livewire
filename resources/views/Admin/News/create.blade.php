                     ...
                     <div class="col-md-8">
                         ...
                         <div class="card">
                             <div class="card-body row">
                                 ...
                                 <div class="form-group col-sm-12" element="div" bp-field-wrapper="true"
                                      bp-field-name="short_description" bp-field-type="textarea">
                                     <label>Table of Content (Html code)</label>
                                     <textarea name="tab_content" id="tab_content" class="form-control" required></textarea>
                                ...
                                <div class="form-check mb-3 ">
                                    ...
                                    <input class="form-check-input ml-2" type="checkbox" name="hot_article" value="1" >
                                  </div>
                                  ...
                                  <div class="form-check mb-3 ">
                                    ...
                                    <input class="form-check-input ml-2" type="checkbox" name="highlighted_article" value="1">
                                  </div>
