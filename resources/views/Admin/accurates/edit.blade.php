    ...
    <main class="main pt-2">
        ...
        <section class="container-fluid">
            <h2 class="ml-1">
                ...
                <small><a href="/admin/accurates" class="d-print-none font-sm"><i class="la la-angle-double-left"></i> Back
                        to
        ...
        <div class="container-fluid animated fadeIn">
            ...
            <div class="row">
                <form method="post" action="{{ url('/admin/accurates/'.$data[0]->id.'') }}" enctype="multipart/form-data">
                                ...
                                <div class="card">
                                    <div class="card-body row">
                                        ...
                                        <div class="form-group col-sm-12" element="div" bp-field-wrapper="true"
                                            ...
                                            <textarea name="short_description" class="form-control" required>{{ $data[0]->short_description }}</textarea>
