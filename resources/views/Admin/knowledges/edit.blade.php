...
<main class="main pt-2">
    ...
    <nav aria-label="breadcrumb" class="d-none d-lg-block">
        <ol class="breadcrumb bg-transparent p-0 justify-content-end">
            ...
            <li class="breadcrumb-item text-capitalize"><a href="/admin/knowledges">knowledges</a></li>
    ...
    <div class="container-fluid animated fadeIn">
        ...
        <div class="row">
            <form   action="{{url('/admin/knowledges/'.$data->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card">
                                <div class="card-body row">
                                    ...
                                    <div class="form-group col-sm-12" element="div" bp-field-wrapper="true"
                                        ...
                                        <textarea name="tab_content" class="form-control" required>{{$data->table_of_contents}}</textarea>
                        ...
                        <div class="col-md-4">
                            ...
                            @foreach($categories as $category)
                                ...
                                <div class="form-check">
                                    ...
                                    <input class="form-check-input" name="category_id[]" type="checkbox" value="{{$category->id}}" id="{{$category->id}}" {{in_array($category->id,$seperated_cat) ? 'checked' : ''}}>
