            ...
            <div class="services-area w-full py-8">
                ...
                <div class="flex-none md:flex md:items-center md:justify-around">
                    <div class="w-full md:w-80 flex flex-col">
                        <h1 class="flex items-center text-base font-normal text-[#26BA65] mb-5"><img src="{{asset('/frontend/assets/img/verified.svg')}}" class="w-6 h-6 mr-2" alt="icon"> Number retention guarantee</h1>
                        <h2 class="text-[#2B313B] text-2xl font-semibold mb-5">Compare your
                            Mobile Plan</h2>
                        <p class="text-[#6C7A93] text-base font-normal mb-5">Compare different providers with or without smartphone</p>
                        
                        <div class="pop-form-main" x-data="{ open: false }">
                            
                        <button type="button"  @click="open = ! open" class="outline-btn btn-translate-z flex md:hidden items-center w-fit bg-[#F9FBFF] text-white text-base font-bold py-2.5 px-6 mb-3">Get Started <img class="ml-4  " src="{{asset('/frontend/assets/img/arrow-white.svg')}}" alt="arrow-icon"></button>
                        ...
                        <div :class="{'block': open, 'hidden': !open}" class="hidden p-5 rounded-2xl border border-[#F5F8FF] bg-white">
                            <form action="" class="flex flex-col">
                                <div class="mb-3">
                                    <label for="" class="block mb-2 text-xs font-normal text-[#2B313B]">Type</label>
                                    
                                    <div class="flex items-center justify-between">
                                        <div class="mb-3"><div class="checkbox-animate">
                                        ...
                                        <div class="mb-3"><div class="checkbox-animate">
                                            <label class="flex text-xs font-normal">
                                              <input checked type="checkbox" class="" name="check">
                                              <span class="input-check"></span>
                                              Sim Only
                                            </label>
                                          </div>
                                ...
                                <div class="mb-3">
                                    <label for="" class="block mb-2 text-xs font-normal text-[#2B313B]">Current Provider</label>
                                    ...
                                    <div class="t-select no-label">
                                            <select id="gender" class="bg-white border border-[#F5F8FF] text-[#2B313B] font-semibold text-xs rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                                                <option class="p-3 bg-white border-b border border-[#cccccc] text-xs rounded-lg font-base" value="Petrol" selected="">T-Mobile</option>
                                ...
                                <div class="mb-3">
                                    <label for="" class="block mb-2 text-xs font-normal text-[#2B313B]">Number </label>                                    
                                        <div class="flex">
                                            <input type="text" 
                                ...
                                <div class="mb-3">                      
                                    <div class="p-5 rounded-2xl border border-[#F5F8FF] bg-white">
                                        <span class="relative flex items-center justify-end">
                                            <label for="minutes3" class="absolute inset-y-0 left-0 font-normal text-xs text-[#2B313B]">Minutes</label> 
                                                <div class="order-3 flex items-center">
                                                </div>
                                        </span>
                                        <input class="w-full"  id="minutes3" name="minutes3" type="range" min="0" max="120" value="40">
                                    </div>                                         
                                    <div class="p-5 rounded-2xl border border-[#F5F8FF] bg-white">
                                        <span class="relative flex items-center justify-end">
                                            <label for="monthly3" class="absolute inset-y-0 left-0 font-normal text-xs text-[#2B313B]">Monthly</label>                                  
                                            
                                                <div class="order-1 font-semibold text-xs text-[#0052FE]  mr-1">€</div>
                                                
                                            </span>
                                        <input class="w-full" id="monthly3" name="monthly3" type="range" min="0" max="500" value="150">
                                    </div>     
                                </div>
                        ...
                        <div class="grid grid-cols-5 gap-2">
                            ...
                            <img src="{{asset('/frontend/assets/img/internet/07.svg')}}" alt="icon">
                        ...
                        <div class="form-area p-5 rounded-2xl border border-[#F5F8FF] bg-white">
                            <form action="" class="flex flex-col">
                                ...
                                <div class="mb-3">                      
                                    <div class="p-5 rounded-2xl border border-[#F5F8FF] bg-white">
                                        <span class="relative flex items-center justify-end">
                                            <label for="minutes" class="absolute inset-y-0 left-0 font-normal text-xs text-[#2B313B]">Minutes</label> 
                                                <div class="order-3 flex items-center">
                                                </div>
                                        </span>
                                        <input class="w-full"  id="minutes" name="minutes" type="range" min="0" max="120" value="40">
                                    </div>                                         
                                    <div class="p-5 rounded-2xl border border-[#F5F8FF] bg-white">
                                        <span class="relative flex items-center justify-end">
                                            <label for="monthly" class="absolute inset-y-0 left-0 font-normal text-xs text-[#2B313B]">Monthly</label>                                  
                                            
                                                <div class="order-1 font-semibold text-xs text-[#0052FE]  mr-1">€</div>
                                                
                                            </span>
                                        <input class="w-full" id="monthly" name="monthly" type="range" min="0" max="500" value="150">
                                    </div>     
                                </div>
                                    <button type="button" class="p-4 text-center outline-btn btn-translate-z bg-[#112954] text-white w-full text-xs font-bold rounded-md">Compare Now</button>
            ...
            <div class="flex flex-col lg:flex-row items-start justify-between">
                <div class="w-full lg:w-80 mb-4 md:mb-0">
                    <div class="p-5 rounded-2xl border border-[#F5F8FF] bg-white">
                        ...
                        <p class="text-[#2B313B] text-base font-normal text-center mt-4 px-2">1. Enter postal code and select package type</p>
                    </div>
                </div>
                <div class="w-full lg:w-80 range-sec mb-4 md:mb-0">
                    <form class="grid grid-cols-1 gap-4">
                        <div class="p-5 rounded-2xl border border-[#F5F8FF] bg-white">
                            <span class="relative flex items-center justify-end">
                                <label for="data" class="absolute inset-y-0 left-0 font-normal text-xs text-[#2B313B]">Data</label> 
                                    <div class="order-3 flex items-center">
                                        <!-- <div id="" class="counter-top font-semibold text-xs text-[#0052FE]"></div> -->
                                        
                                        <div class="font-semibold text-xs text-[#0052FE]">GB</div>
                                    </div>
                            </span>
                            <input id="data" name="data" type="range" min="0" max="5" value="2">
                        </div>                
                        <div class="p-5 rounded-2xl border border-[#F5F8FF] bg-white">
                            <span class="relative flex items-center justify-end">
                                <label for="minutes" class="absolute inset-y-0 left-0 font-normal text-xs text-[#2B313B]">Minutes</label> 
                            ...
                            <input class="w-full"  id="minutes2" name="minutes2" type="range" min="0" max="120" value="40">
                        </div>                                         
                        <div class="p-5 rounded-2xl border border-[#F5F8FF] bg-white">
                            <span class="relative flex items-center justify-end">
                                <label for="monthly2" class="absolute inset-y-0 left-0 font-normal text-xs text-[#2B313B]">Monthly</label>                                  
                                
                                    <div class="order-1 font-semibold text-xs text-[#0052FE]  mr-1">€</div>
                                    
                                </span>
                            <input class="w-full" id="monthly2" name="monthly2" type="range" min="0" max="500" value="150">
                        </div>   
                    </form>
