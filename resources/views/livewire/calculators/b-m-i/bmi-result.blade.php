@section('meta')
    <title>Bmi Result | Bereken.nl</title>
@endsection
<div>
                ...
                <div class="main-inner p-5 border border-[#F5F8FF] rounded-t-2xl">
                    ...
                    <div class="flex-col sm:flex-row flex items-start sm:items-center justify-between">
                        @if ($bmi < 16)
                            <span style="opacity: 0.7"
                                class="bg-[red] text-[white]   text-base font-normal mr-2 px-3 py-3 rounded-lg">Your BMI
                                is: <strong>{{ $bmi }}</strong> Severe Thinness</span>
                        @elseif ($bmi < 18.5 && $bmi >= 16)
                            <span
                                class="bg-[#FFF4E6] text-[#FF7800]  text-base font-normal mr-2 px-3 py-3 rounded-lg">Your
                                BMI is: <strong>{{ $bmi }}</strong> Mild Thinness</span>
                        @elseif ($bmi < 25 && $bmi >= 18.5)
                            <span class="bg-[green] text-[#ffff]  text-base font-normal mr-2 px-3 py-3 rounded-lg">Your
                        ...
                        @else
                            <span style="opacity: 0.7"
                                class="bg-[red] text-[white]  text-base font-normal mr-2 px-3 py-3 rounded-lg">Your
                    ...
                    <div class="info-area py-4">
                        ...
                        <div class="single-info">
                            ...
                            <p class="text-base font-normal text-[#26BA65] my-4">Your ideal weight is between: {{$idealStart}}kg to
                                {{$idealEnd}}kg</p>
                        ...
                        <a href="#" class="text-[#0052FE] font-normal text-xs block mb-2 underline"> - Low-
                            carbohydrate food burns (belly) fat!</a>
                        <a href="#" class="text-[#0052FE] font-normal text-xs block mb-2 underline"> - The 10
                            tastiest low-carbohydrate dishes!</a>
                        <a href="#" class="text-[#0052FE] font-normal text-xs block mb-2 underline"> - Gain weight
                    ...
                    <div class="info-area py-4">
                        ...
                        <div class="single-info">
                            ...
                            <p class="text-[#6C7A93] font-normal text-xs mb-6 leading-6">With a lower, healthy weight,
                                ...
                                large belly size your risk of certain diseases is increased. Adjusting your eating
                                habits is now an important step. Contact the dietitian or general practitioner.</p>
                            <p class="text-base font-normal">Your ideal weight is between: 65.8kg to 71.6kg</p>
                        ...
                        <button id="load-more-btn" type="button"
                            ...
                            View More <img src="assets/img/icons/arrow-right-blue.svg" class="ml-2 inline-block"
                                alt="arrow-icon">
                        </button>
                        ...
                        <div class="bottom-part flex-none lg:flex lg:justify-between">
                            <div class="w-full lg:w-auto more-links">
                                ...
                                <div class="tag-area flex-wrap flex md:flex-none">
                                    <a href="/vat-calculator"
                                        class="btn-tag outline-btn btn-translate-z text-[#0052FE] bg-[#0052FE] hover:text-white border border-[#0052FE] focus:outline-none focus:ring-none font-normal rounded-md transition-all text-[10px] px-2.5 py-1 text-center mr-2 mb-2">Vat Calculator</a>
                            ...
                            <div class="w-full mt-4 lg:mt-0 lg:w-auto social-links text-left lg:text-right">
                                ...
                                <ul class="flex flex-row justify-end">
                                    <li class="flex ml-2"> <a href="{{$fb_url}}" target="_blank" class=" ml-2"><span
                                                class="flex relative">
                                                <span
