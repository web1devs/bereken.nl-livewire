            ...
            <div class="services-area w-full py-8">
                ...
                <div class="flex-none md:flex md:justify-around">
                    <div class="w-full md:w-80 flex flex-col">
                        ...
                        <button type="button"  @click="open = ! open" class="outline-btn btn-translate-z flex md:hidden items-center w-fit bg-[#F9FBFF] text-white text-base font-bold py-2.5 px-6 mb-3">Get Started <img class="ml-4  " src="{{asset('/frontent/assets/img/arrow-white.svg')}}" alt="arrow-icon"></button>
                        ...
                        <div :class="{'block': open, 'hidden': !open}" class="hidden form-area p-5 rounded-2xl border border-[#F5F8FF] bg-white">
                            <form action="" class="flex flex-col">
                                <div class="mb-3">
                                    ...
                                    <div class="t-select no-label">
                                            <select id="gender" class="bg-white border border-[#F5F8FF] text-[#2B313B] font-semibold text-xs rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                                                <option class="p-3 bg-white border-b border border-[#cccccc] text-xs rounded-lg font-base" value="Petrol" selected="">All in One</option>
                                ...
                                <div class="mb-3">
                                    <label for="" class="block mb-2 text-xs font-normal text-[#2B313B]">Zip code </label>                                    
                                        <div class="flex">
                                            <input type="text" 
                                ...
                                <div class="mb-3">
                                    <label for="" class="block mb-2 text-xs font-normal text-[#2B313B]">Housingnumber </label>                                    
                                        <div class="flex mb-3">
                                            <input type="text" 
                                            class="green-tick rounded-lg bg-white border border-[#F5F8FF] text-[#2B313B] font-normal text-xs focus:ring-none focus:outline-none focus:border-[#3b82f6] block flex-1 min-w-0 w-full p-2.5"
                                            placeholder="">
            ...
            <div class="flex flex-col lg:flex-row items-start justify-between">
                <div class="w-full lg:w-80 mb-4 md:mb-0">
                    <div class="p-5 rounded-2xl border border-[#F5F8FF] bg-white">
                        <form action="" class="flex flex-col">
                            <div class="mb-5 mt-2">
                                <label for="" class="block mb-3 text-xs font-normal text-[#2B313B]">Type</label>
                            ...
                            <div class="mb-5">
                                <label for="" class="block mb-3 text-xs font-normal text-[#2B313B]">Zip code </label>                                    
                                    <div class="flex">
                                        <input type="text" 
                                        class="green-tick rounded-lg bg-white border border-[#F5F8FF] text-[#2B313B] font-normal text-xs focus:ring-none focus:outline-none focus:border-[#3b82f6] block flex-1 min-w-0 w-full p-2.5"
                                        placeholder="">
                            ...
                            <div class="mb-10">
                                <label for="" class="block mb-3 text-xs font-normal text-[#2B313B]">Housingnumber </label>                                    
                                    <div class="flex">
                                        <input type="text" 
                                        class="green-tick rounded-lg bg-white border border-[#F5F8FF] text-[#2B313B] font-normal text-xs focus:ring-none focus:outline-none focus:border-[#3b82f6] block flex-1 min-w-0 w-full p-2.5"
                                        placeholder="">
                    ...
                    <form class="grid grid-cols-1 gap-4">
                        <div class="p-5 rounded-2xl border border-[#F5F8FF] bg-white">
                            <span class="relative flex items-center justify-end">
                                <label for="range2" class="absolute inset-y-0 left-0 font-normal text-xs text-[#2B313B]">Download Speed</label> 
                                    <div class="order-3 flex items-center">
                                        <!-- <div id="" class="counter-top font-semibold text-xs text-[#0052FE]"></div> -->
                                        
                                        <div class="font-semibold text-xs text-[#0052FE]">mbps</div>
                                    </div>
                            </span>
                        ...
                        <div class="p-5 rounded-2xl border border-[#F5F8FF] bg-white">
                            <span class="relative flex items-center justify-end">
                                <label for="range1" class="absolute inset-y-0 left-0 font-normal text-xs text-[#2B313B]">Costs per month</label>                                  
                                
                                    <div class="order-1 font-semibold text-xs text-[#0052FE]  mr-1">€</div>
                                    
                                    <div class="order-3 flex items-center">
                                        <!-- <div id="" class="counter-top font-semibold text-xs text-[#0052FE]"></div> -->
                                        <div class="font-semibold text-xs text-[#0052FE] ml-1">to  € 95</div>
                                    </div>
                                </span>
                            <input id="range1" name="range1" type="range" min="0" max="95" value="20">
                        </div>                        
                        <div class="p-5 rounded-2xl border border-[#F5F8FF] bg-white">
                            <span class="relative flex items-center justify-end">
                                <label for="range2" class="absolute inset-y-0 left-0 font-normal text-xs text-[#2B313B]">Number of HD channels</label> 
                                    <div class="order-3 flex items-center">
                                        <!-- <div id="" class="counter-top font-semibold text-xs text-[#0052FE]"></div> -->
                                        <!-- <div class="font-semibold text-xs text-[#0052FE]">mbps</div> -->
                                    </div>
                            </span>
                            <input id="range3" name="range3" type="range" min="0" max="300" value="150">
                        </div>
                    </form>
